...
export class HomeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  nav = [
    ...
    {titleH: "Open", id: 'f-7',  title: '[-',  icon: 'shield-5', query: (w: IWaveSpecification) => !w.waveSpecificationStatus.includes('close') && this.isOpenedLocation(w.waveSpecificationCommissioningDate) || (w.waveSpecificationStatus === 'open only summer season' && this.isSummer)},
    ...
    {titleH: "Closed", id: 'f-9',  title: '[-]', icon: 'shield-0', query: (w: IWaveSpecification) => w.waveSpecificationStatus.includes('close') && this.isOpenedLocation(w.waveSpecificationCommissioningDate)},
